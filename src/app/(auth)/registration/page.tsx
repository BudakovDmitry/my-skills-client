        ...
        <div className="flex justify-center min-h-screen">
            ...
            <div className="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
                <div className="w-full">
                    <h1 className="flex items-center text-2xl font-semibold tracking-wider text-gray-800 capitalize dark:text-white">
                    ...
                    <p className="mt-6 text-sm text-center text-gray-400">Маєте акаунт? <Link href="/login" className="text-blue-500 focus:outline-none focus:underline hover:underline">Sign in</Link>.</p>
