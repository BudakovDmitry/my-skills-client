      ...
      <section className="relative z-50 w-4/5 mx-auto">
        <div className="container">
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="md:text-5xl text-3xl font-medium tracking-tight mt-7">Тарифи</h2>
          ...
          <div className="grid lg:grid-cols-3 grid-cols-1 gap-10 mt-20">
            ...
            <div className="flex flex-col border border-gray-300 rounded-xl overflow-hidden dark:border-gray-700">
              ...
              <div className="p-10">
                ...
                <div className="flex justify-center">
                  <a href="#" className="py-3 px-6 font-medium border rounded-md border-sky-500 text-sky-500 hover:bg-sky-500 hover:text-white transition-all duration-500">Get Basic</a>
                </div>
              </div>
            </div>
                  ...
                  <div className="text-center">
                    <div className="flex flex-col">
                      ...
                      <div className="p-10">
                        ...
                        <div className="flex justify-center">
                          <a href="#" className="py-3 px-6 font-medium border rounded-md border-sky-500 bg-sky-500 text-white hover:bg-sky-500-800">Get Pro</a>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="flex flex-col border border-gray-300 rounded-xl overflow-hidden dark:border-gray-700">
              ...
              <div className="p-10">
                ...
                <div className="flex justify-center">
                  <a href="#" className="py-3 px-6 font-medium border rounded-md border-sky-500 text-sky-500 hover:bg-sky-500 hover:text-white transition-all duration-500">Get Ultimate</a>
                </div>
              </div>
            </div>
          </div>
